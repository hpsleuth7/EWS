...
curl -o /Users/admin/Desktop/EWS/raw_data/curled_data/HPD_com_complaints.csv https://data.cityofnewyork.us/api/views/uwyv-629c/rows.csv?accessType=DOWNLOAD

python /Users/admin/Desktop/EWS/Scripts/DOBCount.py

python /Users/admin/Desktop/EWS/Scripts/furman.py

python /Users/admin/Desktop/EWS/Scripts/helpers.py
